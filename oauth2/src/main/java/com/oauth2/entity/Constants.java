...
public class Constants {
    ...
    //秘钥
    public static String SECRET ="ASDWSXedcRFVtgbYHNujmIKA";
    //授权码过期时间
    public static int CODE_EXPIREIN = 300;
    //refresh_token过期时间
    public static Long REFRESH_TOKEN_EXPIREIN = 2592000L;
    //access_token过期时间
    public static Long ACCESS_TOKEN_EXPIREIN = 7200L;
    
    public static String STATE_IN_REDIS_PERFIX ="OAUTH2:state_";
